    ...
    <main id="top">
      ...
      <div class="content">
        ...
        <section class="section" id="measured-quality" aria-labelledby="measured-quality-title">
          ...
          <div class="principles">
            <article class="principle primary"><span class="kicker">e12 / HELD-OUT</span><h3>30 scenarios. Four live inputs. Three repeats.</h3><p>The published control state is <strong>BLOCKED</strong> until real evidence exists. Live evidence is credential-gated, uses a suite-local USD 15.00 cap, and requires eight human semantic judgments. Missing credentials, MCP, corpus, pricing, or judgments never become a silent offline pass.</p><p class="mono">config_hash: e471c0c687736cac51316dc7d91ccaf78f738cc01b03eea1a02a00f873da85fb</p></article>
            <article class="principle"><span class="kicker">DISCLOSURE</span><h3>Synthetic evidence stays labelled.</h3><p>This project does not access restricted registers. The e11 Gemini live-validation waiver is verified. E12 defaults to paid <code>gemini-3.1-flash-lite</code>; Anthropic remains an explicit alternate. A live report is published only through the artifact-bound e12 publication pointer.</p></article>
