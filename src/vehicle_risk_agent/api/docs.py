    ...
    <main id="top">
      ...
      <div class="content">
        ...
        <section class="section" id="measured-quality" aria-labelledby="measured-quality-title">
          ...
          <div class="principles">
            <article class="principle primary"><span class="kicker">e12 / HELD-OUT</span><h3>30 scenarios. Four live inputs. Three repeats.</h3><p>The published control state is <strong>BLOCKED</strong> until real evidence exists. Live evidence is credential-gated, uses a suite-local USD 15.00 cap, and requires eight human semantic judgments. Missing credentials, MCP, corpus, pricing, or judgments never become a silent offline pass.</p><p class="mono">config_hash: 447fd9fb970ac51de11c203ecf61b4ef818b8972e2e8c2590508faee026060ad · source: 79944207dccc14a386ca95de2e1a7da1a22f0f9f · config_sha256: 18bbd4634baebb1a0d99b7bed83577d2b2966a2e823019fbdfb2be89b6180efd · judgments_sha256: 6ae639422eb27612a3314a60f36cfee000e4f756c2bd7e5cef22f0d561edb996 · evaluation_input_sha256: 904b4f50fb0c265c6f7d24f11ba4049a783b10691c2bec26e4fc3f5946c5e671 · report_bytes_sha256: 5cc536fa8c99f358ac651cc1bf21f3b2e572c05ebce79e88d24aca5e878e4ec5 · run_hash: 4d749d7d465578e5d5c3dfe794797b3f919ec0efeb48e90ddbf04a765ab21889</p></article>
            <article class="principle"><span class="kicker">DISCLOSURE</span><h3>Synthetic evidence stays labelled.</h3><p>This project does not access restricted registers. The e11 Gemini live-validation gate remains a separate release blocker. E12 defaults to paid <code>gemini-3.1-flash-lite</code>; Anthropic remains an explicit alternate. A live report is published only through the artifact-bound e12 publication pointer.</p></article>
