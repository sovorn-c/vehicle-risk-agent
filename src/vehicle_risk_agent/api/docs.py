    ...
    <main id="top">
      ...
      <div class="content">
        ...
        <section class="section" id="measured-quality" aria-labelledby="measured-quality-title">
          ...
          <div class="principles">
            <article class="principle primary"><span class="kicker">e12 / HELD-OUT</span><h3>30 scenarios. Four live inputs. Three repeats.</h3><p>The published control state is <strong>BLOCKED</strong> until real evidence exists. Live evidence is credential-gated, uses a suite-local USD 15.00 cap, and requires eight human semantic judgments. Missing credentials, MCP, corpus, pricing, or judgments never become a silent offline pass.</p><p class="mono">config_hash: 142c4326c9fac7b075a67a12d8882993bf52364afe0c7a35bae9ab29db800ed2</p></article>
            <article class="principle"><span class="kicker">DISCLOSURE</span><h3>Synthetic evidence stays labelled.</h3><p>This project does not access restricted registers. The e11 Gemini live-validation waiver remains release-blocking and is not hidden by the e12 comparison. A live report is published only through the artifact-bound e12 publication pointer.</p></article>
