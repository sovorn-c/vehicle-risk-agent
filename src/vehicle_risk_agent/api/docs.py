    ...
    <main id="top">
      ...
      <div class="content">
        ...
        <section class="section" id="measured-quality" aria-labelledby="measured-quality-title">
          <div class="section-heading"><h2 id="measured-quality-title">Measured quality, honestly reported</h2><p>The versioned comparative evaluation report compares a deterministic offline baseline with live drafting and bounded investigation.</p></div>
          <div class="principles">
            <article class="principle primary"><span class="kicker">BENCHMARK / HELD-OUT</span><h3>30 scenarios. Four live inputs. Three repeats.</h3><p>The published control state is <strong>BLOCKED</strong> until real evidence exists. Live evidence is credential-gated, uses a suite-local USD 15.00 cap, and requires eight human semantic judgments. Missing credentials, MCP, corpus, pricing, or judgments never become a silent offline pass.</p><details><summary style="cursor:pointer;font-size:11px;color:var(--muted);margin-top:10px">Cryptographic provenance hashes</summary><p class="mono">config_hash: 447fd9fb970ac51de11c203ecf61b4ef818b8972e2e8c2590508faee026060ad · source: c2bb92d66557d0dbdbb5f29f9922d446790270b7 · config_sha256: 18bbd4634baebb1a0d99b7bed83577d2b2966a2e823019fbdfb2be89b6180efd · judgments_sha256: 6ae639422eb27612a3314a60f36cfee000e4f756c2bd7e5cef22f0d561edb996 · evaluation_input_sha256: 177cc9691dfa982e1ea9a6863dafbdb4682c4e0af1a6bcf82a88155ca51cc588 · report_bytes_sha256: b647dac2fb18dd8e8b7cfc8f3a24fcbb26afbe65ab4ccfab9d5bae8b15ae5e58 · run_hash: 9b39fa3b393ce6a4c5d23e4f1297e26e85597ae1117e754f5ab51f7e8199feff</p></details></article>
            <article class="principle"><span class="kicker">DISCLOSURE</span><h3>Synthetic evidence stays labelled.</h3><p>This project does not access restricted registers. Live model validation remains a separate release blocker. Evaluation defaults to paid <code>gemini-3.1-flash-lite</code>; Anthropic remains an explicit alternate. A live report is published only through the artifact-bound publication pointer.</p></article>
